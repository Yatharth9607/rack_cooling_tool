...
simulation_options = [
    "AC Fans on UPS",
    "Vent Fans on UPS",
    "Turn on Vent Fans (on UPS)",
]

simulation01 = [
    "AC Unit",
    "Front Ventilation Fan (Economizer Mode)",
    "Rear Ventilation Fan (Economizer Mode)",
    "Both Ventilation Fans (Economizer Mode)",
]
simulation_options01 = [
    "AC Fans (on UPS)",
    "Front Ventilation Fan (on UPS)",
    "Rear Ventilation Fan (on UPS)",
    "Front Ventilation Fan (on UPS)",
    "Rear Ventilation Fan (on UPS)",
    "Both Ventilation Fans (on UPS)",
]
                        ...
                        html.Div(
                            ...
                            children=[
                                ...
                                html.Div(
                                    children=[
                                        html.Label(
                                            children="Total IT Population in Rack (U)",
                                            style={
                                                "display": "inline-block",
                                                "padding-left": "10px",
                                                "padding-right": "10px",
                                ...
                                html.Div(
                                    children=[
                                        html.Label(
                                            children="Number of Blanking Panels in Rack (U)",
                                            style={
                                                "display": "inline-block",
                                                "padding-left": "10px",
                                                "padding-right": "10px",
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        html.Div(
                                            children=[
                                                html.Label(
                                                    "Rack leakage resistance multiplier:"
                                                ),
                                                html.Div(style={"padding-top": "2%"}),
                                                html.Div(
                                                    id="front_leakage-id",
                                                    children=[
                                                        html.Label(
                                                            children="Front Leakage Resistance",
                                                            style={
                                                                "display": "inline-block",
                                                                "textAlign": "center",
                                                                "font-weight": "bold",
                                                ...
                                                html.Div(
                                                    ...
                                                    children=[
                                                        html.Label(
                                                            children="Rear Leakage Resistance",
                                                            style={
                                                                "display": "inline-block",
                                                                "textAlign": "center",
                                                                "font-weight": "bold",
                                        ...
                                        html.Div(
                                            children=[
                                                dcc.Checklist(
                                                    ...
                                                    options=[
                                                        {
                                                            "label": simulation_options01[
                                                                0
                                                            ],
                                                            "value": simulation_options01[
                                                                0
                                                            ],
                                                        }
                                                    ],
                            ...
                            children=[
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        dcc.Dropdown(
                                            id="Q_graph_layout-id",
                                            options=[
                                                {
                                                    "label": "Before Power Failure",
                                                    "value": 1,
                                                },
                                                {
...
# Advanced Popup
@app.callback(Output("advanced-id", "style"), [Input("button", "n_clicks")])
...
@app.callback(
    [
        Output("AC_option", "style"),
        Output("Fake-id1", "style"),
        Output("unit_size-id", "style"),
        Output("Q_AC_max-id", "style"),
        Output("P_AC_stag-id", "style"),
        Output("set_point-id", "style"),
...
@app.callback(
    [
        Output("Fake-id2", "style"),
        Output("Fake-id3", "style"),
        Output("Q_VF_max-id", "style"),
        Output("P_VF_stag-id", "style"),
        Output("Fake-id5", "style"),
    ],
...
@app.callback(Output("q_UPS-id", "min"), [Input("q_IT-id", "value")])
def min_q_UPS(q_IT):
    return q_IT
...
def IT_population_options(size_rack, blanking_panels, size_AC, size_UPS):
    return [
        {"label": i, "value": i}
        for i in range(1, size_rack - blanking_panels - size_AC - size_UPS + 1)
    ]
...
def Blanking_panel_options(size_rack, IT_population, size_AC, size_UPS):
    return [
        {"label": i, "value": i}
        for i in range(0, size_rack - IT_population - size_AC - size_UPS + 1)
    ]
...
def AC_size_options(size_rack, IT_population, blanking_panels, size_UPS):
    return [
        {"label": i, "value": i}
        for i in range(
            1, min(11, size_rack - IT_population - blanking_panels - size_UPS + 1)
        )
    ]
...
def UPS_size_options(size_rack, IT_population, blanking_panels, size_AC):
    return [
        {"label": i, "value": i}
        for i in range(1, size_rack - IT_population - blanking_panels - size_AC + 1)
    ]
...
def rack_graph_update(size_rack, IT_population, blanking_panels, size_AC, size_UPS):
    return {
        ...
        "layout": {
            "title": {
                "text": "Rack size<Br>distribution (U)",
                "x": 0,
                "y": 0.96,
                "font": {"size": "15"},
            },
...
@app.callback(
    [
        Output("Q_graph", "figure"),
        Output("T_graph", "figure"),
        # Output('Q_values-id', 'children'), Output('T_values-id', 'children'),
        Output("global_ar_ss-id", "children"),
        Output("global_ar_tr-id", "children"),
    ],
    [
        Input("case", "value"),
        Input("AC_option", "values"),
        Input("VF_option", "values"),
        Input("size_rack-id", "value"),
        Input("n_IT-id", "value"),
        Input("q_IT-id", "value"),
        Input("n_BP-id", "value"),
        Input("T_AC-id", "value"),
        Input("T_amb-id", "value"),
        Input("size_UPS-id", "value"),
        Input("q_UPS-id", "value"),
        Input("t_UPS-id", "value"),
        Input("size_AC-id", "value"),
        Input("Q_AC_max-id", "value"),
        Input("Q_VF_max-id", "value"),
        Input("P_AC_stag-id", "value"),
        Input("P_VF_stag-id", "value"),
        Input("slider-1", "value"),
        Input("slider-2", "value"),
        Input("Q_graph_layout-id", "value"),
        Input("Temp_range-id", "value"),
    ],
)
def update_graph(
    ss_condition,
    ...
    solveFNM = rack_solver.FNMsolver(
        ss_condition,
        AC_option,
        VF_option,
        size_rack,
    ...
    return [
        {
            "data": [
                go.Bar(
                    ...
                    marker={"color": "purple"},
                    hoverinfo="text",
                    text=[0, round(abs(Q[3] - Q[5]), 2)],
                    name="Rear Leakage",
                    base=[0, -6 * np.sign(Q[3] - Q[5])],
                ),
                go.Bar(
                    x=[0, Q[3] - Q[4]],
                    y=y_axis,
                    ...
                    hoverinfo="text",
                    text=[0, round(abs(Q[3] - Q[4]), 2)],
                    name="Front Leakage",
                    base=[
                        0,
                        6 * np.sign(Q[3] - Q[4])
                        + max(Q[3] - Q[5], 0) * min(Q[3] - Q[4], 0) / abs(Q[3] - Q[4])
                        - min(Q[3] - Q[5], 0) * max(Q[3] - Q[4], 0) / abs(Q[3] - Q[4]),
                    ],
                ),
                go.Bar(
                    x=[0, -Q[5]],
                    ...
                    hoverinfo="text",
                    text=[0, abs(Q[5])],
                    name="Rear Vent Fan Airflow",
                    base=[
                        0,
                        -6 * np.sign(Q[5])
                        + (-max(Q[3] - Q[5], 0) + min(Q[3] - Q[4], 0))
                        * max(Q[5], 0)
                        / abs(Q[5])
                        + (min(Q[3] - Q[5], 0) - max(Q[3] - Q[4], 0))
                        * min(Q[5], 0)
                        / abs(Q[5]),
                    ],
                ),
                go.Bar(
                    ...
                    hoverinfo="text",
                    text=[0, abs(Q[4])],
                    name="Front Vent Fan Airflow",
                    base=[
                        0,
                        6 * np.sign(Q[4])
                        + (max(Q[3] - Q[5], 0) - min(Q[3] - Q[4], 0) + max(Q[5], 0))
                        * min(Q[4], 0)
                        / abs(Q[4])
                        + (-min(Q[3] - Q[5], 0) + max(Q[3] - Q[4], 0) - min(Q[5], 0))
                        * max(Q[4], 0)
                        / abs(Q[4]),
                    ],
                ),
                ...
                go.Bar(
                    ...
                    hoverinfo="text",
                    text=[abs(Q[2])],
                    name="Server Plane Leakage",
                    base=[
                        6 * np.sign(Q[2])
                        + (
                            (Q[0] - min(Q[1], 0)) * max(Q[2], 0) / abs(Q[2])
                            + (max(Q[1], 0) * min(Q[2], 0)) / abs(Q[2])
                        )
                    ],
                ),
            ],
            "layout": {
                "xaxis": {"title": "Airflow rates (cfm)", "showgrid": True},
                "margin": {"l": "55", "b": "40", "r": "0", "t": "0"},
                "barmode": "overlay",
                "hovermode": "closest",
            },
        },
        {
            "data": [
                ...
                go.Scatter(
                    ...
                    marker={"color": "green"},
                    mode="lines",
                    name="ASHRAE Recommended",
                ),
            ],
            "layout": {
                "xaxis": {"title": "Time After Power Failure (s)"},
                "yaxis": {
                    "title": "Temperature (\u00B0F)",
                    "range": T_range,
                    "nticks": 6,
